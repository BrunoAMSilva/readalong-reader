...
.article h2{font-size:1.05em; color:var(--accent); margin:1.6em 0 .3em; line-height:1.4;}
...
:host([focus]) .article h1, :host([focus]) .article h2, :host([focus]) .eyebrow{opacity:.32;}
